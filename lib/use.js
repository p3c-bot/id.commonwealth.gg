...
if (typeof web3 == 'undefined') {
    ...
    displayError(
        `
        <a class="custom-computer only" href="#!" data-link="http://www.youtube.com/embed/TUD-w5P_uAA?enablejsapi=1" data-title="Untuk Menggunakan, Instal sebuah Dompet ETC">Lihat Video</a> 
        <a class="mobile only" href="#!" data-link="http://www.youtube.com/embed/xCyrjiF6f3E?enablejsapi=1" data-title="Untuk Menggunakan, Instal sebuah Dompet ETC">Lihat Video</a>
...
$(".custom-computer only").click(function () { 
var $this = $(this); 
var $iframe = $("<iframe>").attr("src", $this.data("link")).css({"width": 400, "height": 300}); 
var $title = $("<h1>").text($this.data("title")); 
$("#view-video").html($title).append($iframe); $iframe.wrap("<div class='class-video'>"); 
});

$(".mobile only").click(function () { 
var $this = $(this); 
var $iframe = $("<iframe>").attr("src", $this.data("link")).css({"width": 400, "height": 300}); 
var $title = $("<h1>").text($this.data("title")); $("#view-video").html($title).append($iframe); $iframe.wrap("<div class='class-video'>"); 
});
